...
- **功能特性**：
  ...
  - 时间序列统计功能
  - 高质量视频导出
  - 多 CDN 自动切换加载机制，支持国内网络环境
  - **v1.0.3 新增**：随机背景图片功能，支持 50 张精选风景壁纸
  - **v1.0.3 新增**：玻璃拟态（Glassmorphism）界面设计，增强视觉效果
  - **v1.0.3 新增**："切换背景"按钮，支持手动更换背景图片
  - **v1.0.3 优化**：表格表头和行号列透明度，修复滚动时文字重叠问题
- **适用场景**：科研、工程和数据分析场景
- **版本**：v1.0.3（推荐使用）
